...
body {
	...
	background-size: 100% 90%; /* Ensures the image covers the entire container */
	background-position: center; /* Centers the background image */
	background-repeat: no-repeat;
	animation: changeBackground 7s infinite; /* Change every 15 seconds */
}
/* Keyframe Animation for Auto-changing Background */
@keyframes changeBackground {
	0% {
		background-image: url("manila.jpg"); /* Replace with your first image */
	}
	33% {
		background-image: url("bohol.jpg"); /* Replace with your second image */
	}
	66% {
		background-image: url("zamboanga.jpg"); /* Replace with your third image */
	}
	100% {
		background-image: url("manila.jpg"); /* Loop back to the first image */
	}
}
h5.text-light {
	margin-top: 10px;
...
#titleairline {
    ...
    font-weight: bold;
    text-shadow: 3px 3px 6px rgba(255, 215, 0, 0.5); /* Soft gold glow */
}
</style>
<?php
    if(isset($_GET['error'])) {
...
<link rel="stylesheet" type="text/css"
	...
	<div class="main-agileinfo">
		<h1 id="titleairline" class="text-light brand mt-2">
...
.intro_container{width:100%;border-bottom:solid 2px #e4e6e8;padding-top:30px;padding-bottom:30px}
...
.destinations{width:100%;background:#fff;padding-top:40px;padding-bottom:40px}
