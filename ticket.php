...
<style>
body {
    background: radial-gradient(circle, rgba(51, 51, 51, 0.9) 10%, rgba(30, 30, 30, 1) 90%);
    box-shadow: 0px 0px 25px rgba(0, 0, 0, 0.75); /* Deeper shadow for better contrast */
                      ...
                      if($row_f = mysqli_fetch_assoc($result_f)) {
                        ...
                        <div class="col-3 pl-0" style="background-color:#376b8d !important;
                            ...
                            <div class="row justify-content-center">
                                <div class="col-12">                                    
                                    <img src="Airline Logo nobg.png" class="mx-auto d-block"
